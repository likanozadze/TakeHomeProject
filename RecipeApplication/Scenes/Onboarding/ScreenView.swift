...
struct ScreenView: Identifiable, Equatable {
    ...
    static let onboardPages: [ScreenView] = [
        ScreenView(name: "Welcome to Your Good Recipes App", image: Image("onboarding1"), description: ["Your personal culinary assistant for delightful home cooking experiences."], number: 0),
