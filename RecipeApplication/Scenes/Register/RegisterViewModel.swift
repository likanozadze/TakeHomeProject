...
//    func updatePasswordRequirementsLabel(requirementsStatus: [Bool])
//}
//
...
//    private var passwordRequirementsStatus: [Bool] = [true, true, true, true] {
//        didSet {
//            delegate?.updatePasswordRequirementsLabel(requirementsStatus: passwordRequirementsStatus)
//        }
//    }
//    
//    // MARK: - Public Methods
...
//                passwordRequirementsStatus = [true, true, true, true] 
//                delegate?.updatePasswordRequirementsLabel(requirementsStatus: passwordRequirementsStatus)
