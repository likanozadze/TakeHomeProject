...
class RAHeaderView: UIView {
    ...
    private let titleLabel: RATitleLabel = {
        let label = RATitleLabel(textColor: .secondaryTextColor, textAlignment: .left, fontSize: 30, weight: .bold)
        label.text = "Error"
        return label
    }()
    
    private let subTitleLabel: RATitleLabel = {
        let label = RATitleLabel(textColor: .secondaryTextColor, textAlignment: .left, fontSize: 20, weight: .semibold)
        label.text = "Error"
        return label
    }()
